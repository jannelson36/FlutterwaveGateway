...
class FlutterwavePay extends Plugin
{
    ...
    private function addPaymentMethod(Context $context): void
    {
        ...
        $paymentRepository->create([$flutterwavePaymentData], $context);
    }
    ...
    private function getPaymentMethodId(): ?string
    {
        ...
        // Fetch ID for update
        $paymentCriteria = (new Criteria())->addFilter(new EqualsFilter('handlerIdentifier', FluttewavePayment::class));
