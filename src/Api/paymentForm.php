...
<form method="POST" action="processPayment.php" id="paymentForm">
    ...
    <input type="hidden" name="payment_options" value="mpesa"/>
    <!-- Can be card, account, ussd, qr, mpesa, mobilemoneyghana  (optional) -->
    <input type="hidden" name="description" value="iPhone X, 100GB, 32GB RAM"/>
    ...
    <input type="hidden" name="title" value="JK Inc."/>
    ...
    <input type="hidden" name="email" value="jn47@gmail.com"/> <!-- Replace the value with your customer email -->
    <input type="hidden" name="firstname" value="Jake"/>
    <!-- Replace the value with your customer firstname (optional) -->
    <input type="hidden" name="lastname" value="Nigel"/>
    <!-- Replace the value with your customer lastname (optional) -->
    <input type="hidden" name="phonenumber" value="25471223589"/>
    ...
    <input type="hidden" name="ref" value="JN_5a22a7f270abc8879"/>
